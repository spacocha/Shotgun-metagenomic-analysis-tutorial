...
writematrix(pval, "pval_rates_genes_HGnorm108_all_plus_Rand.txt");
writematrix(corr_obs, "corr_rates_genes_HGnorm108_all_plus_Rand.txt");
writematrix(results, "results_R2_rates_genes_HGnorm108_all_plus_Rand.txt");
